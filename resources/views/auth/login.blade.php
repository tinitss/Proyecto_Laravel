	...
	<div class="d-flex justify-content-center h-100">
		<div class="card">
			...
			<div class="card-body">
				<form action="{{ route('login')}}" method="post">
					...
					<div class="row align-items-center">
						<input type="checkbox" class="listo">
						<label for="customControlInline" class="remember">Recuérdame</label>
					</div>
			...
			<div class="card-footer">
				<div class="d-flex justify-content-center registrarse" >
					¿No tienes una cuenta?
					<div class="register_redireccionar">
